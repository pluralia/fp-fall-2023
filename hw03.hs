-- 0. Для чего нужны эти расширения?
...
--     Приведите пример использования инстансов [Int] и RGB реализованных в 3a и 3b (должно получиться 4 примера)
...
-- Реализуйте инстанс Functor для Either' и Pair
