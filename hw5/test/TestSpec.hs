...
spec = do
  ...
  describe "BinHeap" $ do
    let 
      ...
      --    / \       / \
      -- Leaf Leaf Leaf Leaf
      bHeap' = BinNode 3 (BinNode 2 BinLeaf BinLeaf) (BinNode 4 (BinNode 1 BinLeaf BinLeaf) BinLeaf)
      --          3
      --     /        \
      --     2         4
      --    / \       / \
      ...
      -- Leaf Leaf
    it "test siftDown" $ do
      siftDown bHeap `shouldBe` BinNode "2" (BinNode "3" BinLeaf BinLeaf) (BinNode "4" BinLeaf BinLeaf)
      siftDown bHeap' `shouldBe` BinNode 2 (BinNode 3 BinLeaf BinLeaf) (BinNode 4 (BinNode 1 BinLeaf BinLeaf) BinLeaf)
      siftDown bHeap'' `shouldBe` BinNode 2 (BinNode 3 BinLeaf BinLeaf) BinLeaf

    it "test buildHeap" $ do
      buildHeap [3, 2, 4] `shouldBe` BinNode 2 (BinNode 4 BinLeaf BinLeaf) (BinNode 3 BinLeaf BinLeaf)
      buildHeap [3, 2, 4, 1] `shouldBe` BinNode 1 (BinNode 2 (BinNode 3 BinLeaf BinLeaf) BinLeaf) (BinNode 4 BinLeaf BinLeaf)
      buildHeap [3, 2] `shouldBe` BinNode 2 (BinNode 3 BinLeaf BinLeaf) BinLeaf
